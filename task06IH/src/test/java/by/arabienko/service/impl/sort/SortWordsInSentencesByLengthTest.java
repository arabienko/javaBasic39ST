...
public class SortWordsInSentencesByLengthTest {
    SortWordsInSentencesByLength length = new SortWordsInSentencesByLength();
    ...
    public void testSort(CompositeParts compositeParts, CompositeParts expected) {
        CompositeParts actual = (CompositeParts) length.sort(compositeParts);
