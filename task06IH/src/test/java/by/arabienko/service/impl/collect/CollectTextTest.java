...
public class CollectTextTest {
    ...
    public CollectTextTest() {
        this.collectText = new CollectText();
        ...
        CompositeParts parOneSentTwoWordTwoL2 =
                new CompositeParts(TypeRegex.DELIM_SYMBOL.getRegexForSplit());
        ComponentLeaf parOneSentTwoWordTwoL21 =
                new ComponentLeaf(',');
        parOneSentTwoWordTwoL2.addElement(parOneSentTwoWordTwoL21);

        CompositeParts parOneSentTwoLexThree =
                new CompositeParts(TypeRegex.DELIM_LEXEME.getRegexForSplit());
        CompositeParts parOneSentTwoWordOneL3 =
                new CompositeParts(TypeRegex.DELIM_SYMBOL.getRegexForSplit());
        ComponentLeaf parOneSentTwoWordOneL31 =
                new ComponentLeaf('b');
        ComponentLeaf parOneSentTwoWordOneL32 =
                new ComponentLeaf('l');
        ComponentLeaf parOneSentTwoWordOneL33 =
                new ComponentLeaf('a');
        ComponentLeaf parOneSentTwoWordOneL34 =
                new ComponentLeaf('c');
        ComponentLeaf parOneSentTwoWordOneL35 =
                new ComponentLeaf('k');
        ...
        CompositeParts parOneSentTwoWordTwoL3 =
                new CompositeParts(TypeRegex.DELIM_SYMBOL.getRegexForSplit());
        ComponentLeaf parOneSentTwoWordTwoL31 =
                new ComponentLeaf('.');
        ...
        CompositeParts parTwoSentOne =
                new CompositeParts(TypeRegex.DELIM_SENTENCE.getRegexForSplit());
        paragraphTwo.addElement(parTwoSentOne);


        CompositeParts parTwoSentOneLexOne =
                new CompositeParts(TypeRegex.DELIM_LEXEME.getRegexForSplit());
        CompositeParts parTwoSentOneWordOne =
                new CompositeParts(TypeRegex.DELIM_SYMBOL.getRegexForSplit());
        parTwoSentOneLexOne.addElement(parTwoSentOneWordOne);
        ComponentLeaf parTwoSentOneWordOne1 =
                new ComponentLeaf('O');
        ComponentLeaf parTwoSentOneWordOne2 =
                new ComponentLeaf('n');
        ComponentLeaf parTwoSentOneWordOne3 =
                new ComponentLeaf('e');
        ...
        CompositeParts parTwoSentOneLexTwo =
                new CompositeParts(TypeRegex.DELIM_LEXEME.getRegexForSplit());
        CompositeParts parTwoSentOneWordTwo =
                new CompositeParts(TypeRegex.DELIM_SYMBOL.getRegexForSplit());
        parTwoSentOneLexTwo.addElement(parTwoSentOneWordTwo);
        ComponentLeaf parTwoSentOneWordTwo1 =
                new ComponentLeaf('t');
        ComponentLeaf parTwoSentOneWordTwo2 =
                new ComponentLeaf('w');
        ComponentLeaf parTwoSentOneWordTwo3 =
                new ComponentLeaf('o');
        ...
        CompositeParts parTwoSentOneLexThree =
                new CompositeParts(TypeRegex.DELIM_LEXEME.getRegexForSplit());
        CompositeParts parTwoSentOneWordThree =
                new CompositeParts(TypeRegex.DELIM_SYMBOL.getRegexForSplit());
        parTwoSentOneLexThree.addElement(parTwoSentOneWordThree);
        ComponentLeaf parTwoSentOneWordThree1 =
                new ComponentLeaf('t');
        ComponentLeaf parTwoSentOneWordThree2 =
                new ComponentLeaf('h');
        ComponentLeaf parTwoSentOneWordThree3 =
                new ComponentLeaf('r');
        ComponentLeaf parTwoSentOneWordThree4 =
                new ComponentLeaf('e');
        ComponentLeaf parTwoSentOneWordThree5 =
                new ComponentLeaf('e');
        ...
        CompositeParts parTwoSentOneLexFour =
                new CompositeParts(TypeRegex.DELIM_LEXEME.getRegexForSplit());
        CompositeParts parTwoSentOneWord1Four =
                new CompositeParts(TypeRegex.DELIM_SYMBOL.getRegexForSplit());
        parTwoSentOneLexFour.addElement(parTwoSentOneWord1Four);
        ComponentLeaf parTwoSentOneWord1Four1 =
                new ComponentLeaf('f');
        ComponentLeaf parTwoSentOneWord1Four2 =
                new ComponentLeaf('o');
        ComponentLeaf parTwoSentOneWord1Four3 =
                new ComponentLeaf('u');
        ComponentLeaf parTwoSentOneWord1Four4 =
                new ComponentLeaf('r');
        ...
        CompositeParts parTwoSentOneLexL5 =
                new CompositeParts(TypeRegex.DELIM_LEXEME.getRegexForSplit());
        CompositeParts parTwoSentOneWord1L5 =
                new CompositeParts(TypeRegex.DELIM_SYMBOL.getRegexForSplit());
        CompositeParts parTwoSentOneWord2L5 =
                new CompositeParts(TypeRegex.DELIM_SYMBOL.getRegexForSplit());
        parTwoSentOneLexL5.addElement(parTwoSentOneWord1L5);
        ComponentLeaf parTwoSentOneWord1L51 =
                new ComponentLeaf('f');
        ComponentLeaf parTwoSentOneWord1L52 =
                new ComponentLeaf('i');
        ComponentLeaf parTwoSentOneWord1L53 =
                new ComponentLeaf('v');
        ComponentLeaf parTwoSentOneWord1L54 =
                new ComponentLeaf('e');
        ...
        ComponentLeaf parTwoSentOneWord2L51 =
                new ComponentLeaf('.');
        ...
        CompositeParts parTwoSentTwo =
                new CompositeParts(TypeRegex.DELIM_SENTENCE.getRegexForSplit());
        paragraphTwo.addElement(parTwoSentTwo);

        CompositeParts parTwoSentTwoLexOne =
                new CompositeParts(TypeRegex.DELIM_LEXEME.getRegexForSplit());
        CompositeParts parTwoSentTwoWordOne =
                new CompositeParts(TypeRegex.DELIM_SYMBOL.getRegexForSplit());
        ComponentLeaf parTwoSentTwoWordOne1 =
                new ComponentLeaf('R');
        ComponentLeaf parTwoSentTwoWordOne2 =
                new ComponentLeaf('e');
        ComponentLeaf parTwoSentTwoWordOne3 =
                new ComponentLeaf('d');
        ...
        CompositeParts parTwoSentTwoWordTwo =
                new CompositeParts(TypeRegex.DELIM_SYMBOL.getRegexForSplit());
        ComponentLeaf parTwoSentTwoWordTwo1 =
                new ComponentLeaf(',');
        ...
        CompositeParts parTwoSentTwoLexTwo =
                new CompositeParts(TypeRegex.DELIM_LEXEME.getRegexForSplit());
        CompositeParts parTwoSentTwoWordOneL2 =
                new CompositeParts(TypeRegex.DELIM_SYMBOL.getRegexForSplit());
        ComponentLeaf parTwoSentTwoWordOneL21 =
                new ComponentLeaf('g');
        ComponentLeaf parTwoSentTwoWordOneL22 =
                new ComponentLeaf('r');
        ComponentLeaf parTwoSentTwoWordOneL23 =
                new ComponentLeaf('e');
        ComponentLeaf parTwoSentTwoWordOneL24 =
                new ComponentLeaf('e');
        ComponentLeaf parTwoSentTwoWordOneL25 =
                new ComponentLeaf('n');
        ...
        CompositeParts parTwoSentTwoWordTwoL2 =
                new CompositeParts(TypeRegex.DELIM_SYMBOL.getRegexForSplit());
        ComponentLeaf parTwoSentTwoWordTwoL21 =
                new ComponentLeaf(',');
        parTwoSentTwoWordTwoL2.addElement(parTwoSentTwoWordTwoL21);

        CompositeParts parTwoSentTwoLexThree =
                new CompositeParts(TypeRegex.DELIM_LEXEME.getRegexForSplit());
        CompositeParts parTwoSentTwoWordOneL3 =
                new CompositeParts(TypeRegex.DELIM_SYMBOL.getRegexForSplit());
        ComponentLeaf parTwoSentTwoWordOneL31 =
                new ComponentLeaf('b');
        ComponentLeaf parTwoSentTwoWordOneL32 =
                new ComponentLeaf('l');
        ComponentLeaf parTwoSentTwoWordOneL33 =
                new ComponentLeaf('a');
        ComponentLeaf parTwoSentTwoWordOneL34 =
                new ComponentLeaf('c');
        ComponentLeaf parTwoSentTwoWordOneL35 =
                new ComponentLeaf('k');
        ...
        CompositeParts parTwoSentTwoLex4 =
                new CompositeParts(TypeRegex.DELIM_LEXEME.getRegexForSplit());
        CompositeParts parTwoSentTwoWordOneL4 =
                new CompositeParts(TypeRegex.DELIM_SYMBOL.getRegexForSplit());
        ComponentLeaf parTwoSentTwoWordOneL41 =
                new ComponentLeaf('(');
        ComponentLeaf parTwoSentTwoWordOneL42 =
                new ComponentLeaf('(');
        ComponentLeaf parTwoSentTwoWordOneL43 =
                new ComponentLeaf('5');
        ComponentLeaf parTwoSentTwoWordOneL44 =
                new ComponentLeaf('>');
        ComponentLeaf parTwoSentTwoWordOneL45 =
                new ComponentLeaf('>');
        ComponentLeaf parTwoSentTwoWordOneL46 =
                new ComponentLeaf('5');
        ComponentLeaf parTwoSentTwoWordOneL47 =
                new ComponentLeaf(')');
        ComponentLeaf parTwoSentTwoWordOneL48 =
                new ComponentLeaf('^');
        ComponentLeaf parTwoSentTwoWordOneL49 =
                new ComponentLeaf('(');
        ComponentLeaf parTwoSentTwoWordOneL410 =
                new ComponentLeaf('6');
        ComponentLeaf parTwoSentTwoWordOneL411 =
                new ComponentLeaf('<');
        ComponentLeaf parTwoSentTwoWordOneL412 =
                new ComponentLeaf('<');
        ComponentLeaf parTwoSentTwoWordOneL413 =
                new ComponentLeaf('6');
        ComponentLeaf parTwoSentTwoWordOneL414 =
                new ComponentLeaf(')');
        ComponentLeaf parTwoSentTwoWordOneL415 =
                new ComponentLeaf(')');
        ComponentLeaf parTwoSentTwoWordOneL416 =
                new ComponentLeaf('&');
        ComponentLeaf parTwoSentTwoWordOneL417 =
                new ComponentLeaf('2');
        ...
        CompositeParts parTwoSentTwoLex5 =
                new CompositeParts(TypeRegex.DELIM_LEXEME.getRegexForSplit());
        CompositeParts parTwoSentTwoWordOneL5 =
                new CompositeParts(TypeRegex.DELIM_SYMBOL.getRegexForSplit());
        ComponentLeaf parTwoSentTwoWordOneL51 =
                new ComponentLeaf('g');
        ComponentLeaf parTwoSentTwoWordOneL52 =
                new ComponentLeaf('o');
        parTwoSentTwoWordOneL5.addElement(parTwoSentTwoWordOneL51);
        parTwoSentTwoWordOneL5.addElement(parTwoSentTwoWordOneL52);
        CompositeParts parTwoSentTwoWordTwoL5 =
                new CompositeParts(TypeRegex.DELIM_SYMBOL.getRegexForSplit());
        ComponentLeaf parTwoSentTwoWordTwoL51 =
                new ComponentLeaf('.');
        ...
        CompositeParts parThreeSentOne =
                new CompositeParts(TypeRegex.DELIM_SENTENCE.getRegexForSplit());

        CompositeParts parThreeSentOneLexOne =
                new CompositeParts(TypeRegex.DELIM_LEXEME.getRegexForSplit());
        CompositeParts parThreeSentOneWordOne =
                new CompositeParts(TypeRegex.DELIM_SYMBOL.getRegexForSplit());
        ComponentLeaf parThreeSentOneWordOne1 =
                new ComponentLeaf('T');
        ComponentLeaf parThreeSentOneWordOne2 =
                new ComponentLeaf('h');
        ComponentLeaf parThreeSentOneWordOne3 =
                new ComponentLeaf('r');
        ComponentLeaf parThreeSentOneWordOne4 =
                new ComponentLeaf('e');
        ComponentLeaf parThreeSentOneWordOne5 =
                new ComponentLeaf('e');
        ...
        CompositeParts parThreeSentOneLexTwo =
                new CompositeParts(TypeRegex.DELIM_LEXEME.getRegexForSplit());
        CompositeParts parThreeSentOneWord1Two =
                new CompositeParts(TypeRegex.DELIM_SYMBOL.getRegexForSplit());
        parThreeSentOneLexTwo.addElement(parThreeSentOneWord1Two);
        ComponentLeaf parThreeSentOneWordTwo1 =
                new ComponentLeaf('c');
        ComponentLeaf parThreeSentOneWordTwo2 =
                new ComponentLeaf('a');
        ComponentLeaf parThreeSentOneWordTwo3 =
                new ComponentLeaf('t');
        ComponentLeaf parThreeSentOneWordTwo4 =
                new ComponentLeaf('s');
        ...
        CompositeParts parThreeSentOneWord2Two =
                new CompositeParts(TypeRegex.DELIM_SYMBOL.getRegexForSplit());
        parThreeSentOneLexTwo.addElement(parThreeSentOneWord2Two);
        ComponentLeaf parThreeSentOneWord2Two1 =
                new ComponentLeaf('.');
        ...
        CompositeParts parThreeSentTwo =
                new CompositeParts(TypeRegex.DELIM_SENTENCE.getRegexForSplit());
        CompositeParts parThreeSentTwoLexOne =
                new CompositeParts(TypeRegex.DELIM_LEXEME.getRegexForSplit());
        CompositeParts parThreeSentTwoWordOne =
                new CompositeParts(TypeRegex.DELIM_SYMBOL.getRegexForSplit());
        ComponentLeaf parThreeSentTwoWordOne1 =
                new ComponentLeaf('R');
        ComponentLeaf parThreeSentTwoWordOne2 =
                new ComponentLeaf('e');
        ComponentLeaf parThreeSentTwoWordOne3 =
                new ComponentLeaf('d');
        ...
        CompositeParts parThreeSentTwoLexOne1 =
                new CompositeParts(TypeRegex.DELIM_LEXEME.getRegexForSplit());
        CompositeParts parThreeSentTwoWordOne11 =
                new CompositeParts(TypeRegex.DELIM_SYMBOL.getRegexForSplit());
        ComponentLeaf parThreeSentTwoWordOne111 =
                new ComponentLeaf('-');
        parThreeSentTwoWordOne11.addElement(parThreeSentTwoWordOne111);
        parThreeSentTwoLexOne1.addElement(parThreeSentTwoWordOne11);

        CompositeParts parThreeSentTwoLexTwo =
                new CompositeParts(TypeRegex.DELIM_LEXEME.getRegexForSplit());
        CompositeParts parThreeSentTwoWordOneL2 =
                new CompositeParts(TypeRegex.DELIM_SYMBOL.getRegexForSplit());
        ComponentLeaf parThreeSentTwoWordOneL21 =
                new ComponentLeaf('g');
        ComponentLeaf parThreeSentTwoWordOneL22 =
                new ComponentLeaf('r');
        ComponentLeaf parThreeSentTwoWordOneL23 =
                new ComponentLeaf('e');
        ComponentLeaf parThreeSentTwoWordOneL24 =
                new ComponentLeaf('e');
        ComponentLeaf parThreeSentTwoWordOneL25 =
                new ComponentLeaf('n');
        ...
        CompositeParts parThreeSentTwoWordTwoL2 =
                new CompositeParts(TypeRegex.DELIM_SYMBOL.getRegexForSplit());
        ComponentLeaf parThreeSentTwoWordTwoL21 =
                new ComponentLeaf('.');
        ...
        CompositeParts parThreeSentThree =
                new CompositeParts(TypeRegex.DELIM_SENTENCE.getRegexForSplit());
        CompositeParts parThreeSentThreeLexTwo =
                new CompositeParts(TypeRegex.DELIM_LEXEME.getRegexForSplit());
        CompositeParts parThreeSentThreeWord1Two =
                new CompositeParts(TypeRegex.DELIM_SYMBOL.getRegexForSplit());

        ComponentLeaf parThreeSentThreeWordTwo1 =
                new ComponentLeaf('B');
        ComponentLeaf parThreeSentThreeWordTwo2 =
                new ComponentLeaf('y');
        ...
        CompositeParts parThreeSentThreeWord2Two =
                new CompositeParts(TypeRegex.DELIM_SYMBOL.getRegexForSplit());
        ComponentLeaf parThreeSentThreeWord2Two1 =
                new ComponentLeaf('.');
    ...
    @DataProvider(name = "Composite_collect")
    public Object[][] dateForArithmeticSum() {
        String str = "One two three four.  Red, green, black.  \n" +
                "One two three four five.  Red, green, black 0 go.  \n" +
    ...
    @Test(description = "Test collect",
            dataProvider = "Composite_collect")
    public void testCollect(CompositeParts text, String expected) {
        String actual = collectText.collect(text);
