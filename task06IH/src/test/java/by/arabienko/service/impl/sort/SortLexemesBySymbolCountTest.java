...
import by.arabienko.service.impl.parse.ParseTextToParagraphTest;
import org.testng.annotations.DataProvider;
import org.testng.annotations.Test;

import static org.testng.Assert.*;

public class SortLexemesBySymbolCountTest {
    SortLexemesBySymbolCount symbolCount = new SortLexemesBySymbolCount();
    ParseTextToParagraphTest paragraphTest = new ParseTextToParagraphTest();

    @DataProvider(name = "SortLexemesBySymbolCount")
    public Object[][] dateForArithmeticSum() {
        ...
        ComponentLeaf componentLeaf = new ComponentLeaf('e');

        CompositeParts compositeParts = paragraphTest.getText();
        compositeParts.addElement(componentLeaf);

        return new Object[][]{
                new Object[]{compositeParts, text},
        };
    }

    @Test(description = "SortLexemesBySymbolCount",
            dataProvider = "SortLexemesBySymbolCount")
    public void testSort(CompositeParts compositeParts, CompositeParts expected) {
        CompositeParts actual = (CompositeParts) symbolCount.sort(compositeParts);
