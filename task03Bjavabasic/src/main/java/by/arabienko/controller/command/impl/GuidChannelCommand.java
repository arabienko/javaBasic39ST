...
public class GuidChannelCommand implements Command {
    private static final Logger LOGGER = LogManager.getLogger(GuidChannelCommand.class);
    @Override
    public HashMap<String, ProgramGuide.Program> execute(List list) throws ServiceException {
        LOGGER.debug("Task received: "+ GetGuidChannel.class);
        ServiceFactory serviceFactory = ServiceFactory.getInstance();
        return serviceFactory.getGetGuidChannel().
