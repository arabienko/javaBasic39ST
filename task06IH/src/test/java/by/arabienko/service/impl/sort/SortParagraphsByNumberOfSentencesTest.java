...
public class SortParagraphsByNumberOfSentencesTest {
    SortParagraphsByNumberOfSentences sentences = new SortParagraphsByNumberOfSentences();
    ParseTextToParagraphTest paragraphTest = new ParseTextToParagraphTest();

    @DataProvider(name = "composite_sort")
    public Object[][] composite_sort() {
        ...
        CompositeParts text2 = text;


        return new Object[][]{
                new Object[]{compositeParts, text},
                new Object[]{text2, text},

        };
    }

    @Test(description = "Sort",
            dataProvider = "composite_sort")
    public void testSort(CompositeParts compositeParts, CompositeParts expected) {
        CompositeParts actual = (CompositeParts) sentences.sort(compositeParts);
